...
```{python}
![Dropdown Screenshot](dropdown screeshot.png)
```

b. 
```{python}
![Jam-Heavy traffic Screenshot](Jam-Heavy traffic dashboard.png)
```
...
c. 
```{python}
![Road Closure - Event Screenshot](Road Closure - Event.png)
```
...
```{python}
![Accident-Major Screenshot](Accident Major.png)
![Accident-Minor Screenshot](Accident Minor.png)
```
